...
\centerline{
	\begin{minipage}{\linewidth}
		\vspace{12 pt}
		\centering
		\input{BAB-2/figures/sigmoid.pgf}
...
\centerline{
	\begin{minipage}{\linewidth}
		\vspace{12 pt}
		\centering
		\input{BAB-2/figures/softplus.pgf}
...
\centerline{
	\begin{minipage}{\linewidth}
		\vspace{12 pt}
		\centering
		\input{BAB-2/figures/softsign.pgf}
		\captionof{figure}{Plot Fungsi Aktivasi Softplus}
