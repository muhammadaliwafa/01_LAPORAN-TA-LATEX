...
\titleeng{Health Index Diagnosis of Power Transformer using Long Short Term Memory (LSTM)}{}% {Judul} dan {sub judul jika ada} dalam bahasa inggris
...
\tglpengesahan{29 Juni 2021} % Tanggal, bulan, dan tahun digabung
\tglpernyataan{29 Juni 2021} % Tanggal, bulan, dan tahun digabung
...
\frontmatter
\upcoverpage
%\includepdf{Front/COVER_TTD.pdf}
\includepdf{Includes/Pemisah.pdf}
%\lembarpengesahan
\includepdf{Front/Lembar Pengesahan.pdf}
\includepdf{Front/Lembar Pernyataan.pdf}
%\lembarpernyataan
...
%
\includepdf[pages={1-}]{Lampiran-Bimbingan/004_Form Bimbingan TA_Muhammad Ali Wafa_102117002.pdf}
%\includepdf[pages={1-}]{Lampiran-Bimbingan/FORM TA-2 ALI WAFA - BIMBINGAN TUGAS AKHIR CO-EPV.pdf}
